...
const OpdHourController = {
    ...
    create: async (req, res) => {
        try {
            ...
            const opd_hour_exists = await OpdHour.findOne( { where: { 
                hospital_id,
                day: day[1] 
            } } );
    ...
    show: async ( req, res ) => {
        try {
            ...
            await OpdHour.findByPk(opd_hour_id, { where: { hospital_id } })
                .then( response => {
    ...
    update: async ( req, res ) => {
        try {
            ...
            // get the opd hour detail
            const opd_hour = await OpdHour.findByPk( opd_hour_id, { where: { hospital_id } } );
